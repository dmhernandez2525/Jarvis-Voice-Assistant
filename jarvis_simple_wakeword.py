#!/usr/bin/env python3
"""
JARVIS Voice Assistant with Simple Wake Word Detection
Uses energy-based detection - no API key required, 100% offline
"""
...
class JarvisAssistant:
    def __init__(self, model_name="qwen2.5:72b", whisper_model="large"):
        ...
        print("Say 'Jarvis' (or speak loudly) to activate")
        print("="*60 + "\n")
        ...
        try:
            while True:
                ...
                if np.abs(audio).mean() > self.wake_threshold:
                    print("\n🎧 Sound detected, checking for 'Jarvis'...")
                    ...
                    if "jarvis" in text:
                        ...
                        print(f"   False alarm: '{text}' (waiting for 'Jarvis')")
